...
<html>
<head>
  <title>${patient.fullName} - Титриметрия</title>
...
<c:url var="addTitrationTest" value="/test/titration"/>
...
<div class="container">
  <fieldset>
    ...
    <form:form method="post" action="${addTitrationTest}" modelAttribute="medicalTest">
